...
class CostModel:
    ...
    def round_trip_cost(self) -> float:
        """Total cost of an in-and-out taker trade, fraction of notional.

        Two fees + crossing the spread twice + slippage twice. This is the
        number a lead-lag move must *exceed* to make money.
        """
